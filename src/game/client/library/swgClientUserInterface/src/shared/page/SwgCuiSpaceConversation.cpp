...
namespace SwgCuiSpaceConversationNamespace
{
	//------------------------------------------------------------------
	...
	struct ConversationNode
	{
		...
		void setResponses(SwgCuiSpaceConversation::StringVector const & responses);
		SwgCuiSpaceConversation::StringVector const & getResponses() const;
	...
	private:
		...
		SwgCuiSpaceConversation::StringVector m_responses;
...
void SwgCuiSpaceConversation::install()
{
	s_lastSound = new SoundId();
	ExitChain::add(SwgCuiSpaceConversation::remove, "SwgCuiSpaceConversation::remove");
}

//----------------------------------------------------------------------

void SwgCuiSpaceConversation::remove()
{
	delete s_lastSound;
	s_lastSound = NULL;
}
...
void ConversationNode::setResponses(SwgCuiSpaceConversation::StringVector const & responses)
{
...
SwgCuiSpaceConversation::StringVector const & ConversationNode::getResponses() const
{
	return m_responses;
}
...
SwgCuiSpaceConversation::SwgCuiSpaceConversation(UIPage & page) :
SwgCuiLockableMediator("SwgCuiSpaceConversation", page),
...
m_currentNodeId(static_cast<uint32>(-1))
{
	...
	m_callback->connect (*this, &SwgCuiSpaceConversation::onTargetChanged, static_cast<CuiConversationManager::Messages::TargetChanged *>(0));
	m_callback->connect (*this, &SwgCuiSpaceConversation::onResponsesChanged, static_cast<CuiConversationManager::Messages::ResponsesChanged *>(0));
	m_callback->connect (*this, &SwgCuiSpaceConversation::onConversationEnded, static_cast<CuiConversationManager::Messages::ConversationEnded *>(0));
...
SwgCuiSpaceConversation::~SwgCuiSpaceConversation()
{
	m_callback->disconnect (*this, &SwgCuiSpaceConversation::onTargetChanged, static_cast<CuiConversationManager::Messages::TargetChanged *>(0));
	m_callback->disconnect (*this, &SwgCuiSpaceConversation::onResponsesChanged, static_cast<CuiConversationManager::Messages::ResponsesChanged *>(0));
	m_callback->disconnect (*this, &SwgCuiSpaceConversation::onConversationEnded, static_cast<CuiConversationManager::Messages::ConversationEnded *>(0));
...
void SwgCuiSpaceConversation::performActivate()
{
	setIsUpdating(true);
...
void SwgCuiSpaceConversation::performDeactivate()
{
	setIsUpdating(false);
...
void SwgCuiSpaceConversation::onConversationEnded(bool const &)
{
	s_conversationActive = false;
}
...
bool SwgCuiSpaceConversation::setViewerTarget(NetworkId const & target, uint32 appearanceOverrideTemplateCrc)
{
	if (!m_targetViewer)
		return false;
...
void SwgCuiSpaceConversation::setText(Unicode::String const & text)
{
...
Unicode::String const & SwgCuiSpaceConversation::getText() const
{
...
void SwgCuiSpaceConversation::update(float deltaTimeSecs)
{
...
void SwgCuiSpaceConversation::updateResponses(StringVector const & strings)
{
	clearResponses();
...
void SwgCuiSpaceConversation::clearResponses()
{
	m_popup->ClearItems();
	m_popup->Link();
...
void SwgCuiSpaceConversation::OnPopupMenuSelection(UIWidget * context)
{
...
bool SwgCuiSpaceConversation::setTauntInfo(NetworkId const & taunter, Unicode::String const & text, uint32 const appearanceOverloadSharedTemplateCrc, std::string const & soundEffect, float duration)
{
